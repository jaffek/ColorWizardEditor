...
fun CustomTab(
    ...
    singleLineTextBaselineWithIcon : Dp = SingleLineTextBaselineWithIcon,
    doubleLineTextBaselineWithIcon : Dp = DoubleLineTextBaselineWithIcon,
    iconDistanceFromBaseline : TextUnit = IconDistanceFromBaseline,
    activeIndicatorHeight : Dp = ActiveIndicatorHeight,
    iconWithTextTabHeight : Dp = LargeTabHeight,
    textTabHeight : Dp = SmallTabHeight,
    horizontalTextPadding : Dp = HorizontalTextPadding,
    ...
    CustomTab(
        ...
        TabBaselineLayout(
            icon = icon,
            text = styledText,
            singleLineTextBaselineWithIcon = singleLineTextBaselineWithIcon,
            doubleLineTextBaselineWithIcon = doubleLineTextBaselineWithIcon,
            iconDistanceFromBaseline = iconDistanceFromBaseline,
            activeIndicatorHeight = activeIndicatorHeight,
            iconWithTextTabHeight =iconWithTextTabHeight,
            textTabHeight = textTabHeight,
...
private fun TabBaselineLayout(
    text: @Composable (() -> Unit)?,
    icon: @Composable (() -> Unit)?,
    singleLineTextBaselineWithIcon : Dp,
    doubleLineTextBaselineWithIcon : Dp,
    iconDistanceFromBaseline : TextUnit,
    activeIndicatorHeight : Dp,
    iconWithTextTabHeight : Dp,
    textTabHeight : Dp,
